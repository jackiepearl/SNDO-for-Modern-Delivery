...
namespace Team1FinalProject.Migrations
{
    ...
    [Migration("20181106232433_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Team1FinalProject.Models.CouponUserDet", b =>
                {
                    b.Property<int>("CouponUserDetID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("CouponUserDetID");

                    b.HasIndex("CouponID");

                    b.HasIndex("UserId");

                    b.ToTable("CouponUserDets");
                });
            ...
            modelBuilder.Entity("Team1FinalProject.Models.User", b =>
                {
                    b.HasOne("Team1FinalProject.Models.Coupon")
                        .WithMany("Users")
                        .HasForeignKey("CouponID");
                });
